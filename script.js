...
// Установим начальное значение флага видимости кнопок
var locationButtonsVisible = false;

// Функция, которая управляет видимостью кнопок локаций
function toggleLocationButtonsVisibility(visible) {
...
var homeButton = document.querySelector('button[onclick="goToHome()"]');
